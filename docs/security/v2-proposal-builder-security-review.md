...
- Production deployment `dpl_93LxygfP6JVnpPWuanQSkVe61YeF` was verified through the visible in-app browser. At 390px, the real Mapbox selection and generation path completed with a 327-screen proposal, a contained 358×463px blob preview, a separate PDF blob for Open/Download, zero iframes, zero horizontal overflow, and no client error.
