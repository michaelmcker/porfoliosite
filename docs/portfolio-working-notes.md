...
- Desktop source truth is the user-supplied approved black plate at `v2/assets/workflows/content-production-approved-desktop.png`, SHA-256 `8df1ac85b4813445e5ffd836efcd8cce380a945b2a2e315fcead1c297bb1932b`. Never substitute the older light generic diagram or regenerate this file. The cream folder-card rendering is `v2/assets/workflows/content-production-folder-card.png` (SHA-256 `5b06be1b1728b663409ebbbd5b12845bb4e6b0ba5839dca81d5a1327a94b1bca`), cropped from the approved generated folder reference so black interface panels remain black on warm paper.
